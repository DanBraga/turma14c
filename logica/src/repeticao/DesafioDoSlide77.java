...
public class DesafioDoSlide77 {
	...
	public static void main(String[] args) {
		...
		if (contmedio>contsuperior && contmedio>contpos) {
			System.out.println("Maior valor é escolaridade media: " + contmedio);
		} 
		if (contsuperior>contmedio && contsuperior>contpos) {
			System.out.println("Maior valor é escolaridade superior: " + contsuperior);
		}
		if (contpos>contmedio && contpos>contsuperior) {
			System.out.println("Maior valor é escolaridade pos: " + contpos);
		}
	}
}
